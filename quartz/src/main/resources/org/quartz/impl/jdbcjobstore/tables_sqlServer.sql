...
GO
IF EXISTS (SELECT * FROM dbo.sysobjects WHERE id = OBJECT_ID(N'[dbo].[FK_QRTZ_RRULE_TRIGGERS_QRTZ_TRIGGERS]') AND OBJECTPROPERTY(id, N'ISFOREIGNKEY') = 1)
ALTER TABLE [dbo].[QRTZ_RRULE_TRIGGERS] DROP CONSTRAINT FK_QRTZ_RRULE_TRIGGERS_QRTZ_TRIGGERS
GO
...
GO
IF EXISTS (SELECT * FROM dbo.sysobjects WHERE id = OBJECT_ID(N'[dbo].[QRTZ_RRULE_TRIGGERS]') AND OBJECTPROPERTY(id, N'ISUSERTABLE') = 1)
DROP TABLE [dbo].[QRTZ_RRULE_TRIGGERS]
GO
...
GO
CREATE TABLE [dbo].[QRTZ_RRULE_TRIGGERS] (
  [SCHED_NAME] [NVARCHAR] (120)  NOT NULL ,
  [TRIGGER_NAME] [NVARCHAR] (200)  NOT NULL ,
  [TRIGGER_GROUP] [NVARCHAR] (200)  NOT NULL ,
  [RRULE_EXPRESSION] [NVARCHAR] (120)  NOT NULL ,
  [TIME_ZONE_ID] [NVARCHAR] (80)
) ON [PRIMARY]
GO
...
GO
ALTER TABLE [dbo].[QRTZ_RRULE_TRIGGERS] WITH NOCHECK ADD
  CONSTRAINT [PK_QRTZ_RRULE_TRIGGERS] PRIMARY KEY  CLUSTERED
  (
    [SCHED_NAME],
    [TRIGGER_NAME],
    [TRIGGER_GROUP]
...
GO
ALTER TABLE [dbo].[QRTZ_RRULE_TRIGGERS] ADD
  CONSTRAINT [FK_QRTZ_RRULE_TRIGGERS_QRTZ_TRIGGERS] FOREIGN KEY
  (
    [SCHED_NAME],
    [TRIGGER_NAME],
    [TRIGGER_GROUP]
...
GO
CREATE NONCLUSTERED INDEX [IX_QRTZ_RRULE_TRIGGERS_QRTZ_TRIGGERS] ON [dbo].[QRTZ_RRULE_TRIGGERS]
  (
    [SCHED_NAME] ASC,
    [TRIGGER_NAME] ASC,
    [TRIGGER_GROUP] ASC
