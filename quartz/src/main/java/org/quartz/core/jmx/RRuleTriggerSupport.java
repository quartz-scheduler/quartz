...
public class RRuleTriggerSupport {
    private static final String COMPOSITE_TYPE_NAME = "RRuleTrigger";
    private static final String COMPOSITE_TYPE_DESCRIPTION = "RRuleTrigger Details";
    private static final String[] ITEM_NAMES = new String[] { "rruleExpression", "timeZone" };
    private static final String[] ITEM_DESCRIPTIONS = new String[] { "rruleExpression", "timeZone" };
    private static final OpenType[] ITEM_TYPES = new OpenType[] { STRING, STRING };
    private static final CompositeType COMPOSITE_TYPE;
    private static final String TABULAR_TYPE_NAME = "RRuleTrigger collection";
    private static final String TABULAR_TYPE_DESCRIPTION = "RRuleTrigger collection";
    ...
    public static CompositeData toCompositeData(RRuleTrigger trigger) {
        try {
    ...
    public static TabularData toTabularData(List<? extends RRuleTrigger> triggers) {
        TabularData tData = new TabularDataSupport(TABULAR_TYPE);
        if (triggers != null) {
            ArrayList<CompositeData> list = new ArrayList<>();
            for (RRuleTrigger trigger : triggers) {
    ...
    public static OperableTrigger newTrigger(CompositeData cData) throws ParseException {
        RRuleTriggerImpl result = new RRuleTriggerImpl();
        result.setRRuleExpression((String) cData.get("rruleExpression"));
    ...
    public static OperableTrigger newTrigger(Map<String, Object> attrMap) throws ParseException {
        RRuleTriggerImpl result = new RRuleTriggerImpl();
        result.setRRuleExpression((String) attrMap.get("rruleExpression"));
