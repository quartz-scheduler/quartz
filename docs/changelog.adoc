...
* #508 bugfix: Error with H2 1.4.200
* #505 bugfix: CronTrigger.getTriggerBuilder() changes misfire instruction from "ignore misfire" to "smart"
* #491 bugfix: StdJDBCDelegate.selectTriggerToAcquire may not respect maxCount
* #490 bugfix: Return at most maxCount triggers
* #482 depen: Update C3P0 version to 0.9.5.4 (CVE-2019-5427)
* #474 bugfix: StdSchedulerFactory ConcurrentModificationException reading system properties
* #467 bugfix: Security: XXE in initDocumentParser
