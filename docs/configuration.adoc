...
Set to "true" in order to use the enhanced SQL statements that are available in the database.  This is a performance optimization, and is not required for Quartz to work.  The default value is "false".
