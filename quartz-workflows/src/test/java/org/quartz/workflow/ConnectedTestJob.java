...
public class ConnectedTestJob implements Job{
    private final Semaphore semaphore;
    private final List<JobDetailWithPreviousJobKey> executedTestJobs;

    ConnectedTestJob(Semaphore semaphore, List<JobDetailWithPreviousJobKey> executedTestJobs) {
        super();
    ...
    public void execute(JobExecutionContext context) {
        ...
        JobData.setJobOutputData(context, jobDetail.getKey());
        semaphore.release();
    }
}