...
public class CombinedCondition implements WorkflowCondition{
    ...
    CombinedCondition(WorkflowCondition condition) {
    ...
    public String description() {
        return conditions.stream().map(WorkflowCondition::description).collect(Collectors.joining(" and "));
    }
    ...
    @Override
    public CombinedCondition and(WorkflowCondition condition) {
        conditions.add(condition);
        return this;
    }
}
