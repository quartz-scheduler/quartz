...
public class JobDoneCondition implements WorkflowCondition {
    private static final long serialVersionUID = WorkflowCondition.serialVersionUID;
    private final String schedulerName;
    private final JobKey jobKey;

    JobDoneCondition(JobKey jobKey) {
        this(null, jobKey);
    }
    
    @Override
    public String description() {
        return "job " + jobKey + " is done";
    }

    private JobDoneCondition(String schedulerName, JobKey jobKey) {
        super();
        this.jobKey = jobKey;
        this.schedulerName = schedulerName;
    }
    
    public JobDoneCondition onScheduler(String schedulerName) {
        return new JobDoneCondition(schedulerName, jobKey);
    }
