 ...
 */
class QuartzDatabsePauseAndResumeTest extends QuartzDatabaseTestSupport {
    ...
    void testPauseAndResumeTriggers() throws Exception {
        ...
        MatcherAssert.assertThat(state, is(Trigger.TriggerState.NORMAL));
        MatcherAssert.assertThat(state, not(Trigger.TriggerState.PAUSED));
        ...
        MatcherAssert.assertThat(state, is(Trigger.TriggerState.PAUSED));
        MatcherAssert.assertThat(state, not(Trigger.TriggerState.NORMAL));
